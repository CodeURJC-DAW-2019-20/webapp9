...
## Devolver los partidos de un torneo
* #### URL
...
## Devover la imagen de un torneo
* #### URL
    https://localhost:8443/api/tournaments/{id}/image
* #### Operaciones soportadas
    GET
