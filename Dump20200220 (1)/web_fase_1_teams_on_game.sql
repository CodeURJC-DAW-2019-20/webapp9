...
CREATE TABLE `teams_on_game` (
  ...
  `date` varchar(45) COLLATE utf8mb4_da_0900_ai_ci NOT NULL,
...
INSERT INTO `teams_on_game` VALUES (1,1,8,1,'March 16 '),(2,1,3,0,'March 16'),(2,2,5,0,'March 16'),(3,2,6,1,'March 16');
